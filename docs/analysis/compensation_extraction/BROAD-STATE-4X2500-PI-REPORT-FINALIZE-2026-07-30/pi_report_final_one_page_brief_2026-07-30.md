...
Use this report for PI review; manually validate the highest-value schedule pairs; create entry/mid/top profiles; align non-base components; and separate recurring from one-time timing effects. A final or national wage-gap estimate and a causal conclusion should not be issued until that matched structure passes review.
