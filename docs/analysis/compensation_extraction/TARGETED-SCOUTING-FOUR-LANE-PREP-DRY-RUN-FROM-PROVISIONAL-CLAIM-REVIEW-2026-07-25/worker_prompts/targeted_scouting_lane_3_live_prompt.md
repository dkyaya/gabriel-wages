# Targeted scouting lane_3 — future live worker prompt

This prompt is prepared but was not run. A separate future task must authorize live execution.

## Scope

- Input: `targeted_scouting_lane_3_queue_500.csv` with exactly 500 locked candidate targets.
- Primary mechanism: `fiscal_constraint_signal`.
- Secondary mechanisms: `non_safety_constraint_signal|parity_or_internal_equity_signal|gap_narrowing_signal`.
- Source family target: `cba_or_budget_pay_plan_with_explicit_compensation_mechanism`.
