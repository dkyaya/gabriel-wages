# Cumulative 1,000-document extraction preflight

- `quantitative_base_wage` / `cex1000_a1d9a51edbd3611bbd6db0fa`: `success`
- `qualitative_mechanism` / `cex1000_33c44824f357c9463855503a`: `success`
