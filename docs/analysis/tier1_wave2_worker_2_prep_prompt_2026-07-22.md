...
git switch -C tier1_wave2_worker_2_prep_20260722 main
test "$(git branch --show-current)" = "tier1_wave2_worker_2_prep_20260722"
git status --short
...
- Assigned input: `docs/analysis/tier1_wave2_worker_2_scout_input_2026-07-22.csv`
- Expected rows: `50`
...
- Expected wave rank range: `201–250`
- Expected prompt mode: `compact`
- Expected hints: `docs/analysis/municipality_search_hints_2026-07-22.csv`
- Expected input SHA-256: `78ee47781e959867cd1a315228ab63ad2cbfabaf72e9e56cf06baf99db35b508`
...
path = Path("docs/analysis/tier1_wave2_worker_2_scout_input_2026-07-22.csv")
...
assert [int(r["tier1_rank"]) for r in rows] == list(range(201, 251))
...
assert hashlib.sha256(path.read_bytes()).hexdigest() == "78ee47781e959867cd1a315228ab63ad2cbfabaf72e9e56cf06baf99db35b508"
print("PASS: Tier 1 Wave 2 Worker 2 locked-input gate")
PY
```
...
Require `tmp/tier1_wave2_worker_2_prep_dry_run_20260722_attempt1` not to exist, then run exactly:

```bash
test ! -e tmp/tier1_wave2_worker_2_prep_dry_run_20260722_attempt1
...
Create `docs/analysis/tier1_wave2_worker_2_no_network_validation_20260722_attempt1.md` with commands, exit codes, concise output, Python executable, protected-file comparison, and explicit no-network/no-backend confirmation. The locked input/audit/prompt must remain byte-identical.

## Commit and sanitized relay

Stage only worker-created review/validation evidence and commit locally as `Prepare Tier 1 Wave 2 Worker 2 offline dry run`. Do not commit dry-run `tmp/`, `.venv`, `.env`, local excludes, credentials, or unrelated files. Do not push.
...
RELAY="tmp/tier1_wave2_worker_2_prep_relay_2026-07-22_${COMMIT}.zip"
STAGE="tmp/tier1_wave2_worker_2_prep_relay_2026-07-22_${COMMIT}"
test ! -e "$STAGE"
test ! -e "$RELAY"
mkdir -p "$STAGE/docs/analysis" "$STAGE/dry_run" "$STAGE/evidence"
cp docs/analysis/tier1_wave2_worker_2_scout_input_2026-07-22.csv docs/analysis/tier1_wave2_worker_2_input_audit_2026-07-22.md docs/analysis/tier1_wave2_worker_2_prep_prompt_2026-07-22.md "$STAGE/docs/analysis/"
cp docs/analysis/tier1_wave2_worker_2_filter_contract_dry_run_review_20260722_attempt1.md docs/analysis/tier1_wave2_worker_2_no_network_validation_20260722_attempt1.md "$STAGE/docs/analysis/"
cp -R tmp/tier1_wave2_worker_2_prep_dry_run_20260722_attempt1/. "$STAGE/dry_run/"
...
The copied basename must remain `tier1_wave2_worker_2_prep_relay_2026-07-22_<commit>.zip`. Inspect ZIP filenames and stop if any secret/credential/environment/cache path appears.
