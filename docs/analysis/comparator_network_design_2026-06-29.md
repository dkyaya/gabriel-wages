...
| mention_id | source_obs_id | source_corpus | source_type | home_state | home_city | comparator_state | comparator_city | occupation_class | safety_flag | cycle_start | cycle_end | document_date | comparison_dimension | quote | page_or_section | extraction_method | confidence | notes |
|---|---|---|---|---|---|---|---|---|---:|---|---|---|---|---|---|---|---|---|
| `ex_som_spsoa_arlington` | `ma_somerville_police_spsoa_2012` | `causal` | `arbitration_award` | `MA` | `Somerville` | `MA` | `Arlington` | `police` | 1 | `2012-07-01` | `2018-06-30` | `2012-07-01` | `general_comparability` | "Those communities chosen in the Collins Center classification study were Arlington, Brookline, Cambridge, Lowell, Malden, Melrose, Newton, Quincy, and Waltham." | `p.55` | `gabriel_verified_excerpt` | `high` | Named comparator extracted from verified Somerville superior-officers award excerpt. |
| `ex_som_spsoa_cambridge` | `ma_somerville_police_spsoa_2012` | `causal` | `arbitration_award` | `MA` | `Somerville` | `MA` | `Cambridge` | `police` | 1 | `2012-07-01` | `2018-06-30` | `2012-07-01` | `general_comparability` | "Those communities chosen in the Collins Center classification study were Arlington, Brookline, Cambridge, Lowell, Malden, Melrose, Newton, Quincy, and Waltham." | `p.55` | `gabriel_verified_excerpt` | `high` | Same verified excerpt, separate comparator-city row. |
| `ex_som_spea_boston` | `ma_somerville_police_spea_2012` | `causal` | `arbitration_award` | `MA` | `Somerville` | `MA` | `Boston` | `police` | 1 | `2012-07-01` | `2015-06-30` | `2012-07-01` | `wages` | "The Union contends that Boston should be considered as comparable due to its close proximity, its population density, and the fact that it is faced with similar urban policing concerns." | `p.58` | `gabriel_verified_excerpt` | `high` | Comparator city is directly named in a verified relevant excerpt. |
| `ex_boston_btu_cambridge` | `boston_bps_btu_negotiations_page` | `discourse` | `bargaining_update` | `MA` | `Boston` | `MA` | `Cambridge` | `teacher` | 0 |  |  | `2025-06-29` | `salary_schedule` | "Minimum and Maximum Teacher Salary with a Masters Comparisons to Surrounding Districts / School Year 24-25" | `salary comparison table` | `manual_review` | `high` | Verified mechanism-proxy page lists Cambridge among surrounding districts in the visible salary-comparison table. |
| `ex_boston_btu_newton` | `boston_bps_btu_negotiations_page` | `discourse` | `bargaining_update` | `MA` | `Boston` | `MA` | `Newton` | `teacher` | 0 |  |  | `2025-06-29` | `salary_schedule` | "Minimum and Maximum Teacher Salary with a Masters Comparisons to Surrounding Districts / School Year 24-25" | `salary comparison table` | `manual_review` | `high` | Verified mechanism-proxy page lists Newton among surrounding districts in the visible salary-comparison table. |
