# Post-PI Scale-Up Wave 1 Worker 2 Offline Preparation Prompt

Use **Codex Routine / GPT-5.6 Terra Medium**.

Work only in `/Users/joachimjohnson/Documents/RA_2026/Pol_Fire/parallel_worktrees/gabriel-worker-2`. This task is offline/dry-run preparation only. Do not
...
git switch main
git switch -C post_pi_wave1_worker_2_prep_20260723 main
...
- Assigned input: `docs/analysis/post_pi_wave1_worker_2_scout_input_2026-07-23.csv`
- Expected rows: `50`
...
- Expected rank range: `51–100`
- Assignment: `rank_sliced_contiguous`
- Expected SHA-256: `2c45d7ceff4b619b7dfa8d65bf7ce7b7d3846f2ff8a328e76faeec24f10e80a7`
...
message such as `Prepare post-PI Wave 1 Worker 2 offline dry run`. Do not
...
```text
tmp/post_pi_wave1_worker_2_prep_relay_2026-07-23_<commit>.zip
```
...
cp "tmp/post_pi_wave1_worker_2_prep_relay_2026-07-23_<commit>.zip" "$COORDINATOR_TMP/"
cmp "tmp/post_pi_wave1_worker_2_prep_relay_2026-07-23_<commit>.zip" "$COORDINATOR_TMP/post_pi_wave1_worker_2_prep_relay_2026-07-23_<commit>.zip"
```
