# Post-PI Scale-Up Wave 1 Worker 1 Offline Preparation Prompt

Use **Codex Routine / GPT-5.6 Terra Medium**.

Work only in `/Users/joachimjohnson/Documents/RA_2026/Pol_Fire/parallel_worktrees/gabriel-worker-1`. This task is offline/dry-run preparation only. Do not
...
git switch main
git switch -C post_pi_wave1_worker_1_prep_20260723 main
...
- Assigned input: `docs/analysis/post_pi_wave1_worker_1_scout_input_2026-07-23.csv`
- Expected rows: `50`
...
- Expected rank range: `1–50`
- Assignment: `rank_sliced_contiguous`
- Expected SHA-256: `ac1cfad98cf21b97c5845b7b06b48718383668a57ee18a605d50b089fe20b9fc`
...
message such as `Prepare post-PI Wave 1 Worker 1 offline dry run`. Do not
...
```text
tmp/post_pi_wave1_worker_1_prep_relay_2026-07-23_<commit>.zip
```
...
cp "tmp/post_pi_wave1_worker_1_prep_relay_2026-07-23_<commit>.zip" "$COORDINATOR_TMP/"
cmp "tmp/post_pi_wave1_worker_1_prep_relay_2026-07-23_<commit>.zip" "$COORDINATOR_TMP/post_pi_wave1_worker_1_prep_relay_2026-07-23_<commit>.zip"
```
