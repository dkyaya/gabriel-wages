# Source-Review Pilot Operating Handoff

The `SOURCE-REVIEW-BATCH3-3X500-2026-07-24` pilot is locked to 1500 rows in
3 balanced lanes. Run the dry-run source-review command for each
