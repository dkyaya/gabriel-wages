# POST-PI-AGGRESSIVE-ROUND-3X300-2026-07-23 — Post-Lane Merge Handoff
...
2. Run:
   ...
   python scripts/audit_parallel_scout_lanes.py \
     ...
     --output-dir tmp/parallel_scout_rounds/POST-PI-AGGRESSIVE-ROUND-3X300-2026-07-23/post_lane_audit
   ```
