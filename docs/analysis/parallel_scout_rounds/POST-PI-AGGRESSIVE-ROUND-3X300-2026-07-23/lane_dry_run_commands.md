# POST-PI-AGGRESSIVE-ROUND-3X300-2026-07-23 — Lane Dry-Run Command Preview
...
python scripts/gabriel_state_source_scout.py \
  ...
  --output-dir tmp/parallel_scout_rounds/POST-PI-AGGRESSIVE-ROUND-3X300-2026-07-23/lane_1_dry_run_attempt1 \
  --prompt-mode compact \
...
python scripts/gabriel_state_source_scout.py \
  ...
  --output-dir tmp/parallel_scout_rounds/POST-PI-AGGRESSIVE-ROUND-3X300-2026-07-23/lane_2_dry_run_attempt1 \
  --prompt-mode compact \
  --search-hints-csv docs/analysis/municipality_search_hints_2026-07-22.csv \
  --live-hard-cap 300 \
  --sleep-between-prompts 5 \
...
python scripts/gabriel_state_source_scout.py \
  ...
  --output-dir tmp/parallel_scout_rounds/POST-PI-AGGRESSIVE-ROUND-3X300-2026-07-23/lane_3_dry_run_attempt1 \
  --prompt-mode compact \
  --search-hints-csv docs/analysis/municipality_search_hints_2026-07-22.csv \
  --live-hard-cap 300 \
  --sleep-between-prompts 5 \
