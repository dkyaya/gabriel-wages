# POST-PI-CHECKPOINT-ROUND-3X160-2026-07-23 — Post-Lane Merge Handoff
...
1. Preserve every lane output and prove the locked input hashes against
   `docs/analysis/parallel_scout_rounds/POST-PI-CHECKPOINT-ROUND-3X160-2026-07-23/parallel_round_manifest.json`.
2. Run:
   ...
   python scripts/audit_parallel_scout_lanes.py \
     ...
     --output-dir tmp/parallel_scout_rounds/POST-PI-CHECKPOINT-ROUND-3X160-2026-07-23/post_lane_audit
   ```
