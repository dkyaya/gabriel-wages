...
git switch -C tier1_wave2_worker_3_prep_20260722 main
test "$(git branch --show-current)" = "tier1_wave2_worker_3_prep_20260722"
git status --short
...
- Assigned input: `docs/analysis/tier1_wave2_worker_3_scout_input_2026-07-22.csv`
- Expected rows: `50`
...
- Expected wave rank range: `251–300`
- Expected prompt mode: `compact`
- Expected hints: `docs/analysis/municipality_search_hints_2026-07-22.csv`
- Expected input SHA-256: `825b6bb7d31f6e1cdbe9fd00963096a39baf25ebbc89972fc5a84f32aba99ca1`
...
path = Path("docs/analysis/tier1_wave2_worker_3_scout_input_2026-07-22.csv")
...
assert [int(r["tier1_rank"]) for r in rows] == list(range(251, 301))
...
assert hashlib.sha256(path.read_bytes()).hexdigest() == "825b6bb7d31f6e1cdbe9fd00963096a39baf25ebbc89972fc5a84f32aba99ca1"
print("PASS: Tier 1 Wave 2 Worker 3 locked-input gate")
PY
```
...
Require `tmp/tier1_wave2_worker_3_prep_dry_run_20260722_attempt1` not to exist, then run exactly:

```bash
test ! -e tmp/tier1_wave2_worker_3_prep_dry_run_20260722_attempt1
...
Create `docs/analysis/tier1_wave2_worker_3_no_network_validation_20260722_attempt1.md` with commands, exit codes, concise output, Python executable, protected-file comparison, and explicit no-network/no-backend confirmation. The locked input/audit/prompt must remain byte-identical.

## Commit and sanitized relay

Stage only worker-created review/validation evidence and commit locally as `Prepare Tier 1 Wave 2 Worker 3 offline dry run`. Do not commit dry-run `tmp/`, `.venv`, `.env`, local excludes, credentials, or unrelated files. Do not push.
...
RELAY="tmp/tier1_wave2_worker_3_prep_relay_2026-07-22_${COMMIT}.zip"
STAGE="tmp/tier1_wave2_worker_3_prep_relay_2026-07-22_${COMMIT}"
test ! -e "$STAGE"
test ! -e "$RELAY"
mkdir -p "$STAGE/docs/analysis" "$STAGE/dry_run" "$STAGE/evidence"
cp docs/analysis/tier1_wave2_worker_3_scout_input_2026-07-22.csv docs/analysis/tier1_wave2_worker_3_input_audit_2026-07-22.md docs/analysis/tier1_wave2_worker_3_prep_prompt_2026-07-22.md "$STAGE/docs/analysis/"
cp docs/analysis/tier1_wave2_worker_3_filter_contract_dry_run_review_20260722_attempt1.md docs/analysis/tier1_wave2_worker_3_no_network_validation_20260722_attempt1.md "$STAGE/docs/analysis/"
cp -R tmp/tier1_wave2_worker_3_prep_dry_run_20260722_attempt1/. "$STAGE/dry_run/"
...
The copied basename must remain `tier1_wave2_worker_3_prep_relay_2026-07-22_<commit>.zip`. Inspect ZIP filenames and stop if any secret/credential/environment/cache path appears.
