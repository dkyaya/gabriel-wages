...
""")
    ...
    # External-data missingness and future search queue. One row per event for
    # every search family authorized by the task contract.
    missing_rows=[]
    families=[
        ...
        ("recruitment_and_retention","applicant counts, turnover, retention, vacancy duration, recruitment and compensation studies","Tier 1","tests recruitment and retention pressure with comparable administrative outcomes"),
        ("tenure_and_progression","employee tenure, step placement, rank progression, promotion timing, incumbent and new-hire tier","Tier 2","distinguishes contractual progression from compositional or tenure differences"),
        ("implementation","payroll-effective date, ordinance adoption, budget appropriation, contract ratification, payment confirmation","Tier 1","confirms whether negotiated or adopted terms became operative and paid"),
        ("benefits_and_total_compensation","pension contributions, health-cost shares, leave, premium eligibility and take-up, minimum-staffing overtime effects","Tier 2","separates wages from benefits and measures recurring total-compensation effects"),
