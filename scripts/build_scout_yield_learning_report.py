...
WAVES = (
    ...
    {
        "wave_id": "tier1_wave2", "wave_label": "Tier 1 Wave 2 compact/adaptive cross-state",
        "run_id": "all_2026-07-22_195226", "attempted_rows": 150,
        "parseable_rows": 148, "candidate_positive_municipalities": 122,
        "parseable_empty_municipalities": 26, "failure_only_rows": 2,
        "candidate_rows": 327, "runtime_seconds": 5738.638,
        "sleep_between_prompts_seconds": 5,
    ...
    {
        "wave_id": "parallel_round2_3x150",
        "wave_label": "Parallel Round 2 compact/adaptive (3 serialized lanes)",
        "run_id": (
            "all_2026-07-23_182845+all_2026-07-23_183330+"
            "all_2026-07-23_183735"
        ),
        "attempted_rows": 450,
        "parseable_rows": 446,
        ...
        "failure_only_rows": 4,
        "candidate_rows": 985,
        "runtime_seconds": 5615.561,
        "sleep_between_prompts_seconds": 5,
        "source_review_document": "docs/analysis/parallel_round2_3x150_live_collection_result_review_2026-07-23.md",
    },
    {
        "wave_id": "aggressive_3x300_attempt3",
        "wave_label": "Aggressive 3x300 Attempt 3 compact/adaptive (3 serialized lanes)",
        "run_id": (
            "all_2026-07-23_221645+all_2026-07-23_222540+"
            "all_2026-07-23_223840"
        ),
        "attempted_rows": 900,
        "parseable_rows": 899,
        ...
        "failure_only_rows": 1,
        "candidate_rows": 1389,
        "runtime_seconds": 9422.628,
        "sleep_between_prompts_seconds": 5,
        "source_review_document": "docs/analysis/aggressive_3x300_attempt3_live_collection_result_review_2026-07-23.md",
    },
)
...
def main() -> int:
    ...
    if len(state_rows) != 51 or len(wave_rows) != 7:
        raise ValueError("unexpected yield-learning output row count")
    print(
        "Scout yield learning built: states/DC=51; waves=7; "
